...
detector.setModelPath("./resnet.h5")
detector.loadModel()
detections = detector.detectObjectsFromImage(input_image="./test-image.jpg", output_image_path="./output-image.jpg", minimum_percentage_probability=30)
